...
class PermissionsTest extends TestCase
{
    ...
    public function testRepCanSeeDepartment()
    {
        ...
        $this->loginAs('1001')
             ...
             ->click('Member Lists')
             ->seeElement('table')
             ->seeInElement('table td:nth-child(1)', $member1->membership)
             ->dontSeeInElement('table td:nth-child(1)', $member2->membership);
    }
    ...
    public function testCampaignerRoleWorksLikeRep()
    {
        ...
        $this->loginAs('1005')
             ...
             ->click('Member Lists')
             ->seeElement('table')
             ->dontSeeInElement('table td:nth-child(1)', $member1->membership)
